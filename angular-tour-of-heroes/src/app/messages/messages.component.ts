...
export class MessagesComponent implements OnInit {
  ...
  // Angular will inject the singleton MessageService into that property when it creates the 
  // MessagesComponent.
  // The messageService property must be public because you're going to bind to it in the 
  // template.
